...
export default class AddBebidaFormComponent implements OnInit, OnDestroy {
  
  // Arreglo de bebidas
  bebidas: Bebidas[] = [];
  
  // Bebida seleccionada para editar
  bebidaSeleccionada: Bebidas | null = null;
  
  // Variables para el formulario
  nuevaBebida: Omit<Bebidas, 'id'> = {
    nombre: '',
    descripcion: '',
    imagenUrl: '',
    precio: 0,
   ...
   */
  editarBebida(bebida: Bebidas): void {
   ...
   */
  gestionarStock(bebida: Bebidas): void {
